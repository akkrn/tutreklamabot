        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Название аккаунта для удобства",
                        max_length=255,
                    ),
                ),
                (
                    "phone",
                    models.CharField(
                        help_text="Номер телефона аккаунта",
                        max_length=32,
                        unique=True,
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        default=500,
                        help_text="Максимум каналов для этого аккаунта",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["channel"],
                        name="bot_channel_channel_e0c7f4_idx",
                    ),
                    models.Index(
